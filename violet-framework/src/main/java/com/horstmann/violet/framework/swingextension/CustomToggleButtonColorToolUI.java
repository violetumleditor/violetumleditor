 ...
 * 
 */
public class CustomToggleButtonColorToolUI extends BasicPanelUI
{
     ...
     */
    public CustomToggleButtonColorToolUI(Color selectedColor, Color selectedBorderColor, Color unselectedColor,
    ...
    private void paintSelectedBg(Graphics g, JComponent c)
    {
        ...
        g2.setPaint(this.selectedColor);
     ...
     * @param c
     */
    private void paintUnselectedBorder(Graphics g, JComponent c)
    {
        Color currentColor = g.getColor();
        g.setColor(unselectedBorderColor);
        g.drawRect(0, 0, c.getWidth() - 1, c.getHeight() - 1);
        g.setColor(currentColor);
    }
