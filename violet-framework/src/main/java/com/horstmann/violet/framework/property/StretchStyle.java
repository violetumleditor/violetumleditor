 ...
 */
public class StretchStyle extends SerializableEnumeration
{
    /**
     * Private constructor. Note that this class is nearly construct as a singleton.
     */
    private StretchStyle()
    {}

    /** The unique solid linestyle instance */
    public static final StretchStyle HORIZONTAL = new StretchStyle();

    /** The unique dotted linestyle instance */
    public static final StretchStyle VERTICAL = new StretchStyle();
}
